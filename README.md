...
## 🛠️ Desenvolvimento (Como Compilar da Fonte)

Se você deseja compilar o aplicativo a partir do código-fonte, siga estes passos:

1.  **Clone o repositório:**

    ```sh
    git clone https://github.com/andrelmd/cash-fluence-app.git
    cd cash-fluence-app
    ```
...
3.  **Execute o ambiente de desenvolvimento:**
    O Tauri irá instalar as dependências do Rust e compilar o backend automaticamente.
    ```sh
    npm run tauri dev
    ```
