...
export class CategoryService
	implements
		IEntityServiceGetAll<Category>,
		IEntityServiceSave<Category>,
		IEntityServiceUpdate<Category>,
		IEntityServiceDelete<Category>
{
	...
	async update(category: Category) {
		...
		await this.repository.update({ data: { ...category, id: undefined }, where: { id: category.id } })
	...
	async getById(id: number) {
		return this.repository.getOne({ where: { id } })
	}
}
