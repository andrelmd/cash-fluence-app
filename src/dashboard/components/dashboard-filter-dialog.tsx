...
export const DashboardFilterDialog = ({ open, onOpenChange, month, setMoth, year, setYear }: IDashboardFilterProps) => {
		...
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent>
				<FieldSet>
					...
					<FieldDescription>Filtre suas transações por mês e ano.</FieldDescription>
					<FieldGroup>
